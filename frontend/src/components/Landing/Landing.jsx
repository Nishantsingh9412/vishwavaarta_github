...
const Landing = () => {
  ...
  return (
    <React.Fragment>
      <>
        <div id="wrapper">
          <div className={`${CSS.class_ka_naam}`}>{/* jo landing.module.css me di hai  */}
            {/* <h2 className={`${CSS.text_class}`}>Hello World</h2> */}
          </div>
          ...
          <div id="section1" className=" container-fluid p-0">
            <div className="row ">
              <div className="left-box col-sm-6 d-flex align-items-center justify-content-center min-vh-10 p-3">
                <div className="ms-2">
                  {/* <span className="text-start">VishwaVarta</span> */}
                  <br />
                  <h1 className="">
                    Online{" "}
                  ...
                  <br />
                  <p className="">
                    A NLP based chatting platform <br />
                    where chats are translated in real time.
                  </p>
                ...
                <div className="d-flex justify-content-center position-relative">
                  ...
                  >
                    <div>
                      ...
                      <div className="text-center mb-4">VishwaVarta</div>
                      <form>
                        <div className="mb-3">
